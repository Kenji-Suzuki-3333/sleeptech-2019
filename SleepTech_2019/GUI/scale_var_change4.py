...
if __name__ == "__main__":
    ...
    # ボタン
    btn_sleep = tkinter.Button(master=root, text='ねる', command=btn_sleep_click)
    btn_wakeup = tkinter.Button(master=root, text='おきる', command=btn_wakeup_click)
    btn_playstop = tkinter.Button(master=root, text='とめる', command=btn_playstop_click)
